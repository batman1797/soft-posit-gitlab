...
This version (0.4rc) supports:
    ...
    2-bit to 32-bit with two exponential bit (posit_2_t) -> Not fast : Using 32-bits in the background to store all sizes.
        ...
        Exhaustively tested for X=(2:12) : quireX2_fdp_add, quireX2_fdp_sub (using quire32 as the underlying code)
